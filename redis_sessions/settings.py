...
SESSION_REDIS_SOCKET_TIMEOUT = SESSION_REDIS.get('socket_timeout', 0.1) # query timeout
SOCKET_CONNECT_TIMEOUT = SESSION_REDIS.get('socket_connect_timeout', 0.1) # connection timeout
